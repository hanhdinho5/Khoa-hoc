                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status">
                                                <option value="1" @if (old('status', $instructor->status) == 1) selected @endif>
                                                    Hoạt động</option>
                                                <option value="0" @if (old('status', $instructor->status) == 0) selected @endif>Tạm
                                                    khoá</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="form-group fallback w-100">
                                            <input type="file" class="dropify"
                                                data-default-file="{{ asset('uploads/instructors/' . $instructor->image) }}"
                                                name="image">
                                        </div>
                                    </div>
