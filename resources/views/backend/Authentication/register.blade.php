                ...
                <div class="col-md-6">
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    <h4 class="text-center mb-4">Đăng ký tài khoản giảng viên</h4>
                                    <form action="{{ route('register.store') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('contact_en') }}"
                                                name="contact_en" id="contact_en">
                                            @if ($errors->has('contact_en'))
                                                <small
                                                    class="d-block text-danger">{{ $errors->first('contact_en') }}</small>
                                            @endif
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="new-account mt-3">
                                        <p>Đã có tài khoản? <a class="text-primary" href="{{ route('login') }}">Đăng
                                                nhập</a></p>
                                    </div>
                                </div>
                            </div>
