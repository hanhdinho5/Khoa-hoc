            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('material.update', encryptor('encrypt', $material->id)) }}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="lessonId">
                                                @forelse ($lesson as $l)
                                                    <option value="{{ $l->id }}"
                                                        {{ old('lessonId', $material->lesson_id) == $l->id ? 'selected' : '' }}>
                                                        {{ $l->title }}</option>
                                                @empty
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="materialType">
                                                <option value="video" @if (old('materialType', $material->type) == 'video') selected @endif>
                                                    Video
                                                </option>
                                                <option value="document" @if (old('materialType', $material->type) == 'document') selected @endif>
                                                    Document
                                                </option>
                                                <option value="quiz" @if (old('materialType', $material->type) == 'quiz') selected @endif>
                                                    Quiz</option>
                                            </select>
                                        </div>
