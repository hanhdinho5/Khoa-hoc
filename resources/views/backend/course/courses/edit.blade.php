                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if (!fullAccess())
                                <form action="{{ route('course.update', encryptor('encrypt', $course->id)) }}"
                                    method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PATCH')
                                    <input type="hidden" name="uptoken"
                                        value="{{ encryptor('encrypt', $course->id) }}">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="courseDescription_bn">{{ old('courseDescription_bn', $course->description_bn) }}</textarea>
                                            </div>
                                            @if ($errors->has('courseDescription_bn'))
                                                <span class="text-danger">
                                                    {{ $errors->first('courseDescription_bn') }}</span>
                                            @endif
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="courseType">
                                                    <option value="free"
                                                        @if (old('courseType', $course->type) == 'free') selected @endif>Free
                                                    </option>
                                                    <option value="paid"
                                                        @if (old('courseType', $course->type) == 'paid') selected @endif>Paid
                                                    </option>
                                                    <option value="subscription"
                                                        @if (old('courseType', $course->type) == 'subscription') selected @endif>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="courseDifficulty">
                                                    <option value="beginner"
                                                        @if (old('courseDifficulty', $course->difficulty) == 'beginner') selected @endif>Beginner
                                                    </option>
                                                    <option value="intermediate"
                                                        @if (old('courseDifficulty', $course->difficulty) == 'intermediate') selected @endif>Intermediate
                                                    </option>
                                                    <option value="advanced"
                                                        @if (old('courseDifficulty', $course->difficulty) == 'advanced') selected @endif>Advanced
                                                    </option>
                                                </select>
                                            </div>
                                            @if ($errors->has('courseDifficulty'))
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="prerequisites_bn">{{ old('prerequisites_bn', $course->prerequisites_bn) }}</textarea>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="tag">
                                                    <option value="popular"
                                                        @if (old('tag', $course->tag) == 'popular') selected @endif>Popular
                                                    </option>
                                                    <option value="featured"
                                                        @if (old('tag', $course->tag) == 'featured') selected @endif>Featured
                                                    </option>tag
                                                    <option value="upcoming"
                                                        @if (old('tag', $course->tag) == 'upcoming') selected @endif>Upcoming
                                                    </option>
                                                </select>
                                            </div>
                                            @if ($errors->has('tag'))
