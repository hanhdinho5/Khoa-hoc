        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('course.index')}}">Tất cả các khóa học</a></li>
                </ol>
            </div>
        </div>
                        ...
                        <div class="row">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right border py-0">
                                                <div class="py-2">
                                                    <a class="dropdown-item"
                                                        href="{{route('course.edit', encryptor('encrypt',$d->id))}}">Chỉnh sửa</a>
                                                    <a class="dropdown-item text-danger" href="javascript:void(0);"
                                                        onclick="$('#form{{$d->id}}').submit()">Xóa</a>
                                                    <form id="form{{$d->id}}"
                                    ...
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            ...
                                            <ul class="list-group mb-3 list-group-flush">
                                                ...
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <span class="mb-0">Giảng viên :</span>
                                                ...
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    ...
                                                    <strong>{{$d->price?number_format($d->price, 0, ',', '.') . ' VNĐ':'Free'}}</strong>
                                                </li>
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card card-profile">
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            <p class="mt-3 px-4">Không tìm thấy khóa học</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
