                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="questionId">
                                                @forelse ($question as $q)
                                                    <option value="{{ $q->id }}"
                                                        {{ old('questionId', $option->question_id) == $q->id ? 'selected' : '' }}>
                                                        {{ $q->content }}</option>
                                                @empty
                                                    <option value="">Không tồn tại câu hỏi nào</option>
                                                @endforelse
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="is_correct">
                                                <option value="1" @if (old('is_correct', $option->is_correct) == 1) selected @endif>
                                                    Correct</option>
                                                <option value="0" @if (old('is_correct', $option->is_correct) == 0) selected @endif>
                                                    Wrong</option>
                                            </select>
                                        </div>
                                    </div>
