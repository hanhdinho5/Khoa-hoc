                                ...
                                <div class="mb-4">
                                    <div class="ps-0 ">
                                        <label class="text-danger"> *
                                            Vui lòng kiểm tra khóa học của bạn trước khi thanh toán
                                        </label>
                                    </div>
                                </div>
                                <button type="submit" class="button button-lg button--primary w-100"> Nhấp vào đây để xác nhận thanh toán</button>
                            </form>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="productContent__wrapper">
                                ...
                                <div class="productContent">
                                    ...
                                    <div class="productContent-item__info productContent-item">
                                        ...
                                        <div class="price">
                                            <h6 class="font-para--md">{{$details['price'] ?  number_format($details['price'], 0). ' VNĐ' :
                                                'Miễn phí'}}</h6>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <p>{{ number_format((float) isset(session('cart_details')['discount_amount']) ?
                                        session('cart_details')['discount_amount']: 0.00 , 0) . ' VNĐ'}}</p>
                                </li>
                                <li>
                                    <p>Taxes (15%)</p>
                                ...
                                <li>
                                    ...
                                    <p class="total-price font-title--card">{{
                                        number_format((float)session('cart_details')['total_amount'] , 0) . ' VNĐ'}}</p>
                ...
                <div class="row align-items-center justify-content-md-center">
                    <div class="col-lg-5 order-2 order-lg-0">
                        <div class="signup-area-textwrapper">
                            ...
                            <p class="mt-2 mb-lg-4 mb-3">Bạn đã có tài khoản?<a href="#" onclick="hide_signin()"
                            ...
                            <form action="{{route('studentRegister.store','checkout')}}" method="POST">
                                ...
                                <div class="form-element">
                                    <label for="password_confirmation" class="w-100" style="text-align: left;">Xác nhận mật khẩu</label>
                                    <div class="form-alert-input">
