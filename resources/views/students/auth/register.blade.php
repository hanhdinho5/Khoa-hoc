            ...
            <div class="row align-items-center justify-content-md-center">
                <div class="col-lg-5 order-2 order-lg-0">
                    <div class="signup-area-textwrapper">
                        ...
                        <p class="mt-2 mb-lg-4 mb-3">Đã có tài khoản? <a href="{{ route('studentLogin') }}"
                        ...
                        <form action="{{ route('studentRegister.store', 'studentdashboard') }}" method="POST">
                            ...
                            <div class="form-element">
                                <label for="password_confirmation" class="w-100" style="text-align: left;">Xác nhận mật
                                    khẩu</label>
                                <div class="form-alert-input">
                            ...
                            <div class="form-element d-flex align-items-center terms">
                                ...
                                <label for="agree" class="text-secondary mb-0">Chấp nhận <a href="#"
                                        style="text-decoration: underline;">Điểu khoản</a> và <a href="#"
                                        style="text-decoration: underline;">Dịch vụ</a></label>
                            </div>
                            <div class="form-element">
